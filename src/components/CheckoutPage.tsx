...
const CheckoutPage: React.FC<CheckoutPageProps> = ({ onBack, selectedPrice, onSuccess }) => {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'wallets' | 'card'>('wallets');
      ...
      if (cardNumberRef.current && cardMonthRef.current && cardYearRef.current && cardCvvRef.current) {
        try {
          ...
          try {
            ...
            // Verify elements are mounted by checking iframes or inputs are created
            setTimeout(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (paymentMethod === 'card') {
      ...
      setError('Los pagos con billetera digital estarán disponibles pronto');
    }
  };
            ...
            <button
              ...
              className={`w-full flex items-center justify-between p-4 text-left transition-colors ${
                paymentMethod === 'wallets' 
                  ? 'bg-gray-50 border-2 border-apoio' 
            ...
            >
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-5 h-5 text-apoio focus:ring-apoio"
                />
                <span className="font-sen font-semibold">Pagar con billetera</span>
                <svg className="h-6 w-auto ml-2" viewBox="0 0 59 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="h-6 w-auto ml-2" viewBox="0 0 63 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-gray-400">{paymentMethod === 'wallets' ? '−' : '+'}</span>
            </button>
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-200">
                <ul className="space-y-3 mb-4">
                  ...
                  <li className="flex items-center gap-2 text-sm text-gray-700">
                    ...
                    Protección adicional de tu billetera
                  </li>
                </ul>
                <button
                  type="button"
            ...
            >
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-5 h-5 text-apoio focus:ring-apoio"
                />
                <span className="font-sen font-semibold">Tarjeta de crédito</span>
                <img src="/assets/cards.webp" alt="Card brands" className="h-6 ml-2" />
              </div>
              <span className="text-gray-400">{paymentMethod === 'card' ? '−' : '+'}</span>
            </button>
              ...
              <form id="checkout-form" onSubmit={handleSubmit} className="p-4 bg-gray-50 border-t border-gray-200 space-y-4">
                ...
                <div>
                  ...
                  <div 
                    ...
                    ref={cardNumberRef}
                    className="w-full border border-gray-200 rounded-lg bg-gray-50 min-h-[42px]"
                  ></div>
                </div>
